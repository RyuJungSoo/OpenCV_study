...
***
## 로그 변환
로그 함수는 작은 값들의 구간을 넓은 구간의 출력으로 반환하고, 큰 값들의 구간은 상대적으로 좁은 구간의 출력으로 반환하는 특징이 있다. 이를 이용하여 영상 명암비를 조절하는 것이 **로그 변환** 이다.                
<img src="https://user-images.githubusercontent.com/81175672/178390117-45abf201-778e-4861-8aeb-e6d5d91296f2.JPG"  width="500" height="100"/> 
[Gamma 보정에 대해서](https://blog.daum.net/trts1004/12109458)
